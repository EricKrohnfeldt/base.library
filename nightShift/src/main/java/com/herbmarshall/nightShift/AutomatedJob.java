...
/** An hook to execute a night shift process. */
public interface AutomatedJob {

	/**
	 * Begin and endure the relentless descent into the night shift,
	 * where time stretches thin and shadows cling like heavy burdens.
	 */
	void endure();
